...
def generate_launch_description():
    ...
    rosbag_cmd = ExecuteProcess(
        cmd=[
            'ros2', 'bag', 'record',
            '-o', f"bags/potential_fields_{timestamp}",
            '/cmd_vel',
            '/odom',
            '/goal_marker'
        ],
    ...
    calculate_potential_fields_cmd = ExecuteProcess(cmd=[
        'ros2', 'run', 'map_based', 'calculate_potential_fields',
    ], output='screen')
    ...
    return LaunchDescription([
        ...
        goal_x_arg,
        goal_y_arg,
        calculate_potential_fields_cmd,
        sim_world,
        load_cmd,
